...
<body style=""margin: 0; width: 100%; background-color: #f1f5f9; padding: 0; -webkit-font-smoothing: antialiased; word-break: break-word"">
  <div align=""center"" role=""article"" aria-roledescription=""email"" lang=""en"" aria-label=""Confirm Your Email"" style=""background-color: #f1f5f9;"">
          ...
          <table style=""width: 100%;"" cellpadding=""0"" cellspacing=""0"" role=""none"">
            <tr>
              <td class=""sm-px-4"" style=""padding-left: 32px; padding-right: 32px; font-size: 16px; line-height: 24px; color: #334155"">
                <h1 style=""font-size: 30px; line-height: 36px; color: #0f172a; margin: 0 0 40px"">Confirm Your Email</h1>
                <p style=""font-size: 16px; line-height: 24px; color: #475569; margin: 0 0 32px"">Thank you for registering with FlightBooker!<br>
                  Please copy the following token and paste it into the appropriate field to confirm your email address:</p>
                <blockquote style=""border-left: 4px solid #6366f1; margin: 0 0 32px; padding-left: 16px"">
                  <p style=""color: #475569; margin: 0; font-size: 18px; line-height: 28px;"">{token}</p>
                </blockquote>
                <p style=""font-size: 16px; line-height: 24px; color: #475569; margin: 0 0 32px;"">If you did not request this confirmation, you can safely ignore this email.</p>
